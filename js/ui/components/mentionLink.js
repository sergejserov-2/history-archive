...
export function renderMentions(text="",subjects=[],getHref=null){
    if(!text)return"";
...
export function getSubjectHref(subject){
    ...
    url.searchParams.set("modal","subject");
    url.searchParams.set("entityId",subject.id);
