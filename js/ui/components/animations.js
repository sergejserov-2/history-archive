...
function getHiddenOffset(el) {
     ...
     *
     * Небольшой запас гарантирует,
     * что элемент полностью выйдет.
     */
    ...
    /*
     * Смотрим, к какой стороне родителя
     * элемент находится ближе.
     *
     * Важно:
     * мы не связываем горизонтальное
     * движение с вертикальным.
     */
    ...
    /*
     * Элемент ближе к левой стороне —
     * уводим полностью влево.
     */
    ...
    /*
     * Элемент ближе к правой стороне —
     * уводим полностью вправо.
     */
        ...
        function frame(now) {
            ...
            el._animationTimer =
                setTimeout(() => {
                    ...
                    /*
                     * После анимации возвращаем
                     * управление обычному CSS.
                     */
